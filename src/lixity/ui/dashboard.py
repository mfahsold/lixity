...
def render_dashboard(
    ...
    if controls:
        ...
        parts.append('        <div class="file-dropzone" id="import-dropzone" tabindex="0" role="button" aria-label="Manuskriptdatei auswählen oder ablegen">')
        ...
        parts.append(f'          <label for="import-proj-title" class="ctl-label">{L("title")}</label>')
        ...
        parts.append(f'            <label for="import-proj-lang" class="ctl-label">{L("language")}</label>')
        ...
        parts.append(f'            <label for="import-proj-path" class="ctl-label">{"Projektordner (optional)" if is_de else "Project folder (optional)"}</label>')
        ...
        parts.append('        </div>')
        parts.append('        <div class="form-group">')
        parts.append(f'          <label style="display:inline-flex;align-items:center;gap:.45rem;cursor:pointer;font-size:.85rem;"><input type="checkbox" id="import-proj-research"/> <span>{"Recherche- und Dossierspeicher anlegen (research/)" if is_de else "Initialize research archive (research/)"}</span></label>')
        parts.append('        </div>')
        ...
        parts.append('      </div>')
        parts.append('      <div class="form-group" style="margin-top:.4rem;">')
        parts.append(f'        <label for="open-proj-path" class="ctl-label">{"Oder Pfad eingeben:" if is_de else "Or enter folder / file path:"}</label>')

...
6. Synchronize README, Pages, agent/API guidance and the implementation status.
   No non-functional research tab or provider controls in the existing dashboard.
...
Claims, author decisions, dossier reconciliation, migration of existing dossiers,
PDF/OCR, Zotero, hybrid retrieval, shared services and interactive research UI
remain separate increments. Local text ingestion does not imply permission to
